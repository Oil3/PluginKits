...
Edit Sep25: FYI if you need to register or re-register, a system extension, you can always drag/drop the _.appex _i n the sidebar's bottom 'UTI informations' box, which for _.appex_ will manually register it.    
